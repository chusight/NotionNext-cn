...
const BLOG = {
  ...
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/avatar.svg', // 站点头像/Logo，默认用 Notion 页面图标，可自定义为图片路径
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一名设计师', // 作者简介
  ...
  // 自定义菜单
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu类型的菜单，替代了3.12版本前的Page类型；false 时使用 Page 类型的 customNav 自动导航
